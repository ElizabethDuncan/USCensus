...
def processData():
	...
	for i in range(0, length(listofFips)):
		LatLongFipsAndValue[listofCoords[i]] = [listofFips[i], listofValues[i]]
	...
	return render_template("testing.html", data = LatLongFipsAndValue, lat = lat, lng = lng, z = z)
